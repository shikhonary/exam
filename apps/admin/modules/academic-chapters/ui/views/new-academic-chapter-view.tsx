...
import { CreateAcademicChapterForm } from "../form/academic-chapter-form";

export function NewAcademicChapterView() {
  return (
    <div className="min-h-screen bg-surface relative isolate">
      ...
      <main className="container mx-auto px-6 py-12 lg:px-12 max-w-4xl relative z-10">
        <div className="mb-8">
          ...
          >
            <Link href="/academic-chapters">
              <ArrowLeft className="w-4 h-4 mr-2" />
              Back to Academic Chapters
            </Link>
          </Button>
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-extrabold tracking-tight text-on-surface">
              Create Academic Chapter
            </h1>
          </div>
          <p className="text-on-surface-variant ml-14">
            Add a new academic chapter and assign it to a subject and academic year.
          </p>
        </div>
