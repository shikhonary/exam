...
import { Building2, CheckCircle2, XCircle, Ban, BookOpen, Activity, Hash, LucideIcon } from "lucide-react";
...
export function AcademicClassStatCards({ stats, isLoading }: StatsProps) {
  if (isLoading) {
    return (
