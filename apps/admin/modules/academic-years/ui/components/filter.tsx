      ...
      <div className="bg-white p-4 flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-4 flex-1">
          ...
          <div className="w-full sm:w-48">
            <Select
              value={currentSort || "startDate-desc"}
            ...
            >
              ...
              <SelectContent className="rounded-xl border-outline/10 shadow-ambient">
                <SelectItem value="startDate-desc" className="font-bold">Newest First</SelectItem>
                <SelectItem value="startDate-asc" className="font-bold">Oldest First</SelectItem>
                <SelectItem value="label-asc" className="font-bold">Name (A-Z)</SelectItem>
                <SelectItem value="label-desc" className="font-bold">Name (Z-A)</SelectItem>
              </SelectContent>
            </Select>
          </div>
        </div>
        ...
        {hasActiveFilters && (
          ...
          >
            <div className="flex flex-wrap items-center gap-2 px-4 pb-4 pt-0">
              ...
              {currentSort && currentSort !== "startDate-desc" && (
                <Badge
                  variant="secondary"
                  className="flex items-center gap-1.5 px-3 py-1 bg-white border border-primary/10 text-xs text-primary shadow-sm rounded-lg hover:bg-white"
                >
