...
import { useMCQFilters } from "@workspace/api-client";
      ...
      <div className="bg-white p-4 flex flex-wrap items-center justify-between gap-4">
        <div className="flex flex-wrap items-center gap-4 flex-1">
          ...
          <div className="w-full sm:w-40">
            <Select
              value={filters.type === null ? "all" : String(filters.type)}
              onValueChange={(val) =>
                handleFilterTypeChange(val === "all" ? null : val)
              }
              disabled={isLoading}
            >
          ...
          <div className="w-full sm:w-40">
            <Select
              value={filters.subjectId === null ? "all" : String(filters.subjectId)}
              onValueChange={(val) =>
                setFilters({ ...filters, subjectId: val === "all" ? null : val, page: 1 })
              }
              disabled={isLoading}
            >
              <SelectTrigger className="h-10 bg-surface-container-low border-none rounded-[12px] px-4 text-sm font-bold text-on-surface focus:ring-2 focus:ring-primary/60">
          ...
          <div className="w-full sm:w-48">
            ...
            >
              ...
              <SelectContent className="rounded-xl border-outline/10 shadow-ambient">
                ...
                <SelectItem value="question-asc" className="font-bold">Question (A-Z)</SelectItem>
                <SelectItem value="question-desc" className="font-bold">Question (Z-A)</SelectItem>
              </SelectContent>
            </Select>
          </div>
        </div>
            ...
            <div className="flex flex-wrap items-center gap-2 px-4 pb-4 pt-0">
              ...
              {filters.type !== null && (
                ...
                >
                  ...
                  <span className="font-bold text-[11px]">{mcqTypeOptions.find(o => String(o.value) === String(filters.type))?.label || filters.type}</span>
              ...
              {filters.subjectId !== null && (
                ...
                >
                  ...
                  <span className="font-bold text-[11px]">{subjects.find(s => s.value === filters.subjectId)?.labelEn || filters.subjectId}</span>
