...
import { QuestionTypeForm } from "../form/question-type-form";

export function EditQuestionTypeView({ id }: { id: string }) {
  return (
      ...
      <main className="container mx-auto px-6 py-12 lg:px-12 max-w-4xl relative z-10">
        <div className="mb-8">
          ...
          <p className="text-on-surface-variant ml-14">
            Update the settings for this question type.
          </p>
        </div>
