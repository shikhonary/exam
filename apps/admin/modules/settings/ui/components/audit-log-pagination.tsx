...
import { useAuditLogFilters } from "@workspace/api-client";
...
export function AuditLogPagination({ totalItem }: PaginationProps) {
  ...
  return (
    <div className="px-8 py-5 flex items-center justify-between border-t border-outline/5 bg-white rounded-b-2xl">
