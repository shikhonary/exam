...
import { ChangePlanForm } from "../form/change-plan-form";

export function ChangePlanView({ id }: { id: string }) {
  return (
      ...
      <main className="container mx-auto px-6 py-12 lg:px-12 max-w-4xl relative z-10">
        <div className="mb-8">
          ...
          <p className="text-on-surface-variant ml-14">
            Upgrade or downgrade this tenant to a different plan.
          </p>
        </div>
