...
interface AdmissionFee extends TenantTypes.Fee {
  _count: {
    students: number;
  };
}
...
export function FeeCard({
  ...
  const capacityPercentage = Math.min(
    (fee._count.students / fee.capacity) * 100,
    100,
  );
            ...
            <div className="flex justify-between items-start">
              ...
              <div className="flex bg-white/[0.02] rounded-xl p-1 gap-1">
                <Button
                  ...
                  onClick={() => onToggleActive?.(fee.id)}
                  title={fee.isActive ? "ইনঅ্যাক্টিভ করুন" : "অ্যাক্টিভ করুন"}
                >
                  {fee.isActive ? (
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center text-[10px] font-black uppercase tracking-widest">
                ...
                <span className="text-foreground flex items-center gap-1.5">
                  {fee._count.students}/{fee.capacity}
                  <span
                    className={cn(
            ...
            <div className="flex justify-between items-center mb-2">
              <div className="flex -space-x-2">
                {[1, 2, 3].map((i) => (
                  ...
                  >
                    <AvatarImage
                      src={`https://i.pravatar.cc/150?u=${fee.id}${i}`}
                    />
              ...
              >
                {fee.isActive ? "অ্যাক্টিভ" : "ইনঅ্যাক্টিভ"}
              </Badge>
            </div>
            <Button
              asChild
