...
import { LayoutGrid, Edit2, Trash2, MoreVertical, Calendar, GraduationCap, Hash } from "lucide-react";
...
export function CounterGrid({ fees, isLoading, onEdit, onDelete }: CounterGridProps) {
  if (isLoading) {
    return (
      ...
      <div className="py-20 flex flex-col items-center justify-center text-center space-y-4">
        ...
        <div className="space-y-1">
          ...
          <p className="text-muted-foreground max-w-xs mx-auto text-sm">
            নতুন কাউন্টার যোগ করতে 'নতুন যোগ করুন' বাটনে ক্লিক করুন।
          </p>
        </div>
      </div>
    );
        ...
        >
          ...
          <div className="flex justify-between items-start mb-4 relative z-10">
            <div>
              ...
              <h3 className="text-2xl font-black text-primary tracking-tight flex items-center"><Hash className="w-5 h-5 mr-1" strokeWidth={3} />{fee.value}</h3>
            </div>
            <DropdownMenu>
