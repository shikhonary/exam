...
import { MoreHorizontal, Edit, Trash2, Calendar, BookOpen, Layers, Hash } from "lucide-react";
...
export const CounterTable = ({ fees, isLoading, onEdit, onDelete }: CounterTableProps) => {
  if (isLoading) {
    return (
