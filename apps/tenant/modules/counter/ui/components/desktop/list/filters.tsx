        ...
        <div className="flex items-center gap-3">
          ...
          >
            ...
            <SelectContent className="rounded-xl border-white/[0.08] bg-[#111b2e] text-foreground">
              ...
              <SelectItem value="value-asc" className="focus:bg-[rgba(0,229,160,0.08)] focus:text-primary">পরিমাণ (কম-বেশি)</SelectItem>
              <SelectItem value="value-desc" className="focus:bg-[rgba(0,229,160,0.08)] focus:text-primary">পরিমাণ (বেশি-কম)</SelectItem>
            </SelectContent>
          </Select>
        </div>
                  ...
                  <span className="font-bold text-[11px]">
                    {(() => {
                      const sortLabels = {
                        ...
                        "value-asc": "পরিমাণ (কম-বেশি)",
                        "value-desc": "পরিমাণ (বেশি-কম)",
                      } as const;
