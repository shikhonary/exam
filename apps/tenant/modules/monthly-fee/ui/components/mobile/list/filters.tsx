    ...
    <div className="flex items-center gap-2 w-full">
      ...
      >
        ...
        <SelectContent className="rounded-xl border-white/[0.08] bg-[#111b2e] shadow-xl text-foreground">
          ...
          <SelectItem value="amount-asc" className="text-xs font-medium focus:bg-[rgba(0,229,160,0.08)] focus:text-primary">
            পরিমাণ (কম-বেশি)
          </SelectItem>
          <SelectItem value="amount-desc" className="text-xs font-medium focus:bg-[rgba(0,229,160,0.08)] focus:text-primary">
            পরিমাণ (বেশি-কম)
          </SelectItem>
        </SelectContent>
      </Select>
