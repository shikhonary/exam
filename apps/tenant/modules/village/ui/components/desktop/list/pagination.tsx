...
import { useVillageFilters } from "@workspace/api-client";
...
export function Pagination({ total }: PaginationProps) {
  ...
  return (
    <div className="px-8 py-5 flex items-center justify-between border-t border-slate-100 bg-white rounded-b-[32px]">
