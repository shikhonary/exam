...
import { ShortAnswerService } from "../services/short-answer.service";
...
export const shortAnswerRouter = createTRPCRouter({
  list: adminProcedure
    ...
    .query(async ({ ctx, input }) => {
      const service = new ShortAnswerService(ctx.db);
  ...
  create: baseMutationProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      return {
        success: true,
        message: "Short Answer created successfully",
        data,
      };
    }),
  ...
  update: baseMutationProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      return {
        success: true,
        message: "Short Answer updated successfully",
        data,
      };
    }),
  ...
  bulkCreate: baseMutationProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      return {
        success: true,
        message: `${data?.count ?? 0} Short Answers created successfully`,
        data,
      };
    }),
  ...
  bulkDelete: baseMutationProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      return {
        success: true,
        message: "Short Answers deleted successfully",
        data,
      };
    }),
